          ...
          {showProductModal && (
            ...
            >
              <form onSubmit={handleProductSubmit} className="space-y-4">
                ...
                <div className="sticky bottom-0 z-20 -mx-5 mt-6 flex gap-3 border-t border-slate-200/70 bg-white/85 px-5 py-4 backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/85 sm:-mx-6 sm:px-6">
